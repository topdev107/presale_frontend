    ...
    <div>
      ...
      </div>
      {
        props.errMsg !== '' ? (
          props.needInt ? (
            <div>
              <CFormInput type="number" min='0' autoFocus className='input-highlighted' placeholder="0" value={props.value} onChange={props.onChange} />
              <div className='danger small-text-sz mb-0'>{props.errMsg}</div>
            </div>
          ) : (
            <div>
              <CFormInput type="number" autoFocus min='0' step='any' className='input-highlighted' placeholder="0" value={props.value} onChange={props.onChange} />
              <div className='danger small-text-sz mb-0'>{props.errMsg}</div>
            </div>
          )
