    ...
    <div>
      ...
      </div>
      {
        props.errMsg !== '' ? (
          ...
          props.needInt ? (
            <CFormInput type="number" min='0' placeholder="0" value={props.value} onChange={props.onChange} />
          ) : (
            <CFormInput type="number" min='0' step='any' placeholder="0" value={props.value} onChange={props.onChange} />
          )
        )
      }
