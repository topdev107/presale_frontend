          ...
          (
            ...
            <div className='timer'>
              ...
              <CRow className='mb-2'>
                ...
                <CCol className='xs-2 medium-text-sz text-right font-300' style={{fontWeight: 300}}>{hardcap} {unit} </CCol>
              </CRow>
        ...
        >
          <CCardBody >
            ...
            <RowBetween
              ...
              childEnd = {<p className="text-right m-0">{hardcap * presaleRate} {tokenSymbol}</p>}
            />
            <RowBetween
              childStart = 'Tokens For Liquidity'
              childEnd = {<p className="text-right m-0">{hardcap * listingRate * liquidityPercent / 100} {tokenSymbol}</p>}
            />
            <RowBetween
              childStart = 'Presale Rate'
              childEnd = {<p className="text-right m-0">1 {unit} = {presaleRate} {tokenSymbol}</p>}
            />
            <RowBetween
              childStart = 'Listing Rate'
              childEnd = {<p className="text-right m-0">1 {unit} = {listingRate} {tokenSymbol}</p>}
            />
            {
              useVesting === true ? (
              <>
                <RowBetween
                  ...
                  childEnd = {<p className="text-right m-0">{firstReleasePresale}%</p>}
                />
                <RowBetween
                  childStart = 'Vesting For Presale'
                  childEnd = {<p className="text-right m-0">{vestingPresalePercent}% each {vestingPresaleTime} minutes</p>}
                />
              </> ) : (<> </>)
            }
            <RowBetween
            ...
            <RowBetween
              childStart = 'Hard Cap'
              childEnd = {<p className="text-right m-0">{hardcap} {unit}</p>}
            /> 
            <RowBetween
              childStart = 'Unsold'
              childEnd = {<p className="text-right m-0">{unsold}</p>}
            />
            <RowBetween
        ...
        >
          <CCardBody>
            ...
            <RowBetween
              ...
              childEnd = {<p className='danger text-right m-0'>{saleType}</p>}
            />
            <RowBetween
              childStart = "Minimum Buy"
              childEnd = {<p className='text-right m-0'>{minBuy} {unit}</p>}
            />
            <RowBetween 
              childStart = "Maximum Buy"
              childEnd = {<p className='text-right m-0'>{maxBuy} {unit}</p>}
            />
          </CCardBody>
        </CCard>
        <br/>
        ...
        >
          ...
          <CCardBody>
              ...
              />
              {
                ...
                (
                    ...
                    <div className="d-grid gap-1">
                      ...
                      <button type="button" className = "btn btn-outline-primary" style={{ width: '100%'}} onClick={() => setVisible(!publicvisible)}>Setting time to public</button>
            ...
            <div className="d-grid gap-2">
              {
                useVesting ? (
                <button type="button" className="btn btn-primary" shape = "rounded-2">List of contributors</button>
                ): (<></>)
              }
              {
